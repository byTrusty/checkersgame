...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Gaming Computer\PycharmProjects\checkers_game'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Gaming Computer\PycharmProjects\checkers_game\Scripts\deactivate.nu'
